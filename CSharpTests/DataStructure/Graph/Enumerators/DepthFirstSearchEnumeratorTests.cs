...
{
    [TestClass()]
    public class DepthFirstSearchEnumeratorTests
    {
        [TestMethod()]
        public void DepthFirstSearchEnumeratorTestCase1()
        {
            var expectedOutputSequence = "1, 3, 4, 5, 6, 7, 8, 2, ";
            ...
            var iterator = new DepthFirstSearchEnumerator<int, int>(graph);
        ...
        [TestMethod()]
        public void DepthFirstSearchEnumeratorTestCase2()
        {
            var expectedOutputSequence = "1, 3, 4, 8, 5, 7, 6, 2, ";
